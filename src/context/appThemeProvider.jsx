      ...
      createTheme({
        palette: {
          ...
          text: {
            ...
            secondary: resolvedMode === 'light' ? '#235347' : '#8EB79B',
          },
          divider: resolvedMode === 'light' ? '#8EB79B' : '#163B32',
          grey: {
            100: resolvedMode === 'light' ? '#DAF1DE' : '#0B2B26',
            200: resolvedMode === 'light' ? '#8EB79B' : '#163B32',
            300: resolvedMode === 'light' ? '#235347' : '#8EB79B',
